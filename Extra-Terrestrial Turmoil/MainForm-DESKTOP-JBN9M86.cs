    ...
    public partial class MainForm : Form
    {
      ...
      //  SoundPlayer soundExplosion = new SoundPlayer(Properties.Resources.RyanSnookExplosion);
        ...
        public MainForm()
        {
            ...
            //sounds
            soundExplosion.settings.volume = 40;
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                if (e.KeyCode == Keys.Escape) PauseMenu(); //Pauses the game
            ...
            if (!p1Dead) //Player1's Movement and shooting switches
            {
                ...
                if (e.KeyCode == Keys.Space) { if(!shoot) MakeBullet(); shoot = true; } //Shoots for player1
            }
            ...
            if (!p2Dead) //Player2's Movement and shooting switches
            {
                ...
                if (e.KeyCode == Keys.Enter) { if (!shoot2) MakeBullet2(); shoot2 = true; } //Shoots for player2
            }
        ...
        private void PlayerMovement()
            {
                ...
                if (!p1IsRed) // if player1 is not red
                {
                    if (p1Ship == "Speedster")
                    {
                        if (right == true) { pPlayer.Left += playerSpeed; pPlayer.Image = Properties.Resources.RightAn; }
                        if (left == true) { pPlayer.Left -= playerSpeed; pPlayer.Image = Properties.Resources.LeftAn; }
                        if (up == true) { pPlayer.Top -= playerSpeed; pPlayer.Image = Properties.Resources.UpAn; }
                        if (down == true) { pPlayer.Top += playerSpeed; pPlayer.Image = Properties.Resources.DownAn; }
                    }
        ...
        private void VictorySequence()
        {
            ...
            if(gameMode == 2)
            {
                ...
                if (p1Dead && p2Dead) { textform.text = "\r\nNo one wins!"; textform.Text = "Draw!"; }
                if (!p1Dead && !p2Dead) { textform.text = "\r\nNo one wins!"; textform.Text = "Draw!"; }
                textform.ShowDialog();
            }
        ...
        private void PowerUpsManager()
        {
            ...
            if (rnum == 1)//????
            {
                ...
                picPowerUp.Location = new System.Drawing.Point(81, 248);
                picPowerUp.Name = "picPowerUp";
            ...
            else if(rnum == 2)//Extra Life
            {
                ...
                picPowerUp.Location = new System.Drawing.Point(170, 112);
                picPowerUp.Name = "picPowerUp";
                picPowerUp.Size = new System.Drawing.Size(48, 49);
                picPowerUp.SizeMode = System.Windows.Forms.PictureBoxSizeMode.StretchImage;
            }
            picPowerUp.Tag = "PowerUp";
        }
        ...
        private void PhaseControl()
            ...
            //All Phases for Arcade
                ...
                if (enemySpawn == 3) //Middle Spawn
                {
                    ...
                    if (rb2Players.Checked == false && phase == 1 && p1Score >= 50      ||  rb2Players.Checked == true && phase == 1 && (p1Score + p2Score) >= 70)        { phase++; start = true;   speedt = false;  enemySpawn = 3; } //1 move - slow - middle
                    if (rb2Players.Checked == false && phase == 2 && p1Score >= 150     ||  rb2Players.Checked == true && phase == 2 && (p1Score + p2Score) >= 230)       { phase++; speedt = false; maxEnemies = 2;  enemySpawn = 2; } // 2 move - slow - out
                    if (rb2Players.Checked == false && phase == 3 && p1Score >= 500     ||  rb2Players.Checked == true && phase == 3 && (p1Score + p2Score) >= 450)       { phase++; speedt = false; maxEnemies = 2;  enemySpawn = 1; } // 2 move - slow - random
                    if (rb2Players.Checked == false && phase == 4 && p1Score >= 600     ||  rb2Players.Checked == true && phase == 4 && (p1Score + p2Score) >= 600)       { phase++; speedt = false; maxEnemies = 3;  enemySpawn = 3; } // 3 move - slow - middle
                    if (rb2Players.Checked == false && phase == 5 && p1Score >= 1100     ||  rb2Players.Checked == true && phase == 5 && (p1Score + p2Score) >= 750)       { phase++; speedt = false; maxEnemies = 3;  enemySpawn = 2; } // 3 move - slow - out
                    if (rb2Players.Checked == false && phase == 6 && p1Score >= 2500     ||  rb2Players.Checked == true && phase == 6 && (p1Score + p2Score) >= 900)       { phase++; speedt = true;  maxEnemies = 3;  enemySpawn = 2; } // 3 move - fast - out
                    if (rb2Players.Checked == false && phase == 7 && p1Score >= 7500     ||  rb2Players.Checked == true && phase == 7 && (p1Score + p2Score) >= 1200)      { phase++; speedt = true;  maxEnemies = 3;  enemySpawn = 3; } // 3 move - fast - middle 
                    if (rb2Players.Checked == false && phase == 8 && p1Score >= 10000    ||  rb2Players.Checked == true && phase == 8 && (p1Score + p2Score) >= 1650)      { phase++; speedt = false; maxEnemies = 3;  enemySpawn = 1; } // 3 move - slow - random
                    if (rb2Players.Checked == false && phase == 9 && p1Score >= 12000    ||  rb2Players.Checked == true && phase == 9 && (p1Score + p2Score) >= 1800)      { phase++; speedt = true;  maxEnemies = 3;  enemySpawn = 1; } // 3 move - fast - random
                    if (rb2Players.Checked == false && phase == 10 && p1Score >= 13000   ||  rb2Players.Checked == true && phase == 10 && (p1Score + p2Score) >= 1950)     { phase++; speedt = false; maxEnemies = 4;  enemySpawn = 3; } // 4 move - slow - middle
                    if (rb2Players.Checked == false && phase == 11 && p1Score >= 20000   ||  rb2Players.Checked == true && phase == 11 && (p1Score + p2Score) >= 2250)     { phase++; speedt = true;  maxEnemies = 4;  enemySpawn = 3; }
                    if (rb2Players.Checked == false && phase == 12 && p1Score >= 30000   ||  rb2Players.Checked == true && phase == 12 && (p1Score + p2Score) >= 2400)     { phase++; speedt = false; maxEnemies = 4;  enemySpawn = 2; }
                    if (rb2Players.Checked == false && phase == 13 && p1Score >= 33000  ||  rb2Players.Checked == true && phase == 13 && (p1Score + p2Score) >= 2700)     { phase++; speedt = true;  maxEnemies = 4;  enemySpawn = 2; }
                    if (rb2Players.Checked == false && phase == 14 && p1Score >= 37000   ||  rb2Players.Checked == true && phase == 14 && (p1Score + p2Score) >= 2850)     { phase++; speedt = false; maxEnemies = 4;  enemySpawn = 1; }
                    if (rb2Players.Checked == false && phase == 15 && p1Score >= 39000   ||  rb2Players.Checked == true && phase == 15 && (p1Score + p2Score) >= 3000)     { phase++; speedt = true;  maxEnemies = 4;  enemySpawn = 1; }
                    if (rb2Players.Checked == false && phase == 16 && p1Score >= 43000   ||  rb2Players.Checked == true && phase == 16 && (p1Score + p2Score) >= 3300)     { phase++; speedt = false; maxEnemies = 5;  enemySpawn = 3; } // 5 move - slow - middle
                    if (rb2Players.Checked == false && phase == 17 && p1Score >= 50000   ||  rb2Players.Checked == true && phase == 17 && (p1Score + p2Score) >= 3600)     { phase++; speedt = true;  maxEnemies = 5;  enemySpawn = 3; }
                    if (rb2Players.Checked == false && phase == 18 && p1Score >= 55000   ||  rb2Players.Checked == true && phase == 18 && (p1Score + p2Score) >= 150000)   { phase++; speedt = false; maxEnemies = 5;  enemySpawn = 2; }
                    if (rb2Players.Checked == false && phase == 19 && p1Score >= 70000   ||  rb2Players.Checked == true && phase == 19 && (p1Score + p2Score) >= 150000)   { phase++; speedt = true;  maxEnemies = 5;  enemySpawn = 2; }
                    if (rb2Players.Checked == false && phase == 20 && p1Score >= 80000   ||  rb2Players.Checked == true && phase == 20 && (p1Score + p2Score) >= 150000)   { phase++; speedt = false; maxEnemies = 5;  enemySpawn = 1; }
                    if (rb2Players.Checked == false && phase == 21 && p1Score >= 90000   ||  rb2Players.Checked == true && phase == 21 && (p1Score + p2Score) >= 150000)   { phase++; speedt = true;  maxEnemies = 5;  enemySpawn = 1; }
                    if (rb2Players.Checked == false && phase == 22 && p1Score >= 95000   ||  rb2Players.Checked == true && phase == 22 && (p1Score + p2Score) >= 150000)   { phase++; speedt = true;  maxEnemies = 6;  enemySpawn = 3; } // 6 is all fast
                    if (rb2Players.Checked == false && phase == 23 && p1Score >= 100000   ||  rb2Players.Checked == true && phase == 23 && (p1Score + p2Score) >= 150000)   { phase++; speedt = true;  maxEnemies = 6;  enemySpawn = 2; }
                    if (rb2Players.Checked == false && phase == 24 && p1Score >= 110000   ||  rb2Players.Checked == true && phase == 24 && (p1Score + p2Score) >= 150000)   { phase++; speedt = true;  maxEnemies = 6;  enemySpawn = 1; }
                    if (rb2Players.Checked == false && phase == 25 && p1Score >= 120000   ||  rb2Players.Checked == true && phase == 25 && (p1Score + p2Score) >= 150000)   { phase++; speedt = true;  maxEnemies = 7;  enemySpawn = 1; } //7+ is all fast - random
                    if (rb2Players.Checked == false && phase == 26 && p1Score >= 150000  ||  rb2Players.Checked == true && phase == 26 && (p1Score + p2Score) >= 150000)   { phase++; speedt = true;  maxEnemies = 8;  enemySpawn = 1; }
                    if (rb2Players.Checked == false && phase == 27 && p1Score >= 170000  ||  rb2Players.Checked == true && phase == 27 && (p1Score + p2Score) >= 150000)   { phase++; speedt = true;  maxEnemies = 9;  enemySpawn = 1; }
                    if (rb2Players.Checked == false && phase == 28 && p1Score >= 200000 ||  rb2Players.Checked == true && phase == 28 && (p1Score + p2Score) >= 150000)   { phase++; speedt = true;  maxEnemies = 10; enemySpawn = 1; }
            } //if (phase >= 1 && enemies < maxEnemies && !killall && gameMode != 2)
        }
